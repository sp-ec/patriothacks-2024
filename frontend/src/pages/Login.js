                    ...
                    <form className="space-y-4 md:space-y-2 text-center">
                        ...
                        <div>
                            ...
                            <div className="mt-3 flex-row">
                                <input id="checkbox" type="checkbox" checked={this.state.rememberMe} onChange={this.handleCheckboxChange} className="appearance-none bg-gray-400 w-4 h-4 rounded-bl-sm rounded-tr-sm"></input>
